                            ...
                            <div class="card p-4 rounded-plus bg-faded">
                                <?php if (!empty($errors)): ?>
                                    <div class="alert alert-danger text-dark" role="alert">
                                        <strong>Уведомление!</strong> <?= $getError("errException") ?>
                                    </div>
                                <?php endif; ?>
                                <form id="js-reg" action="" novalidate="" method="post" class="<?= $hasErrors ? 'was-validated' : '' ?>">
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-md-4 ml-auto text-right">
                                            <button id="js-reg-btn" type="submit" class="btn btn-block btn-danger btn-lg mt-3">Регистрация</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
